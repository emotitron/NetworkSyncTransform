...
{
	/// <summary>
	/// Wrapper class for FloatCrusher that allows sharing of a common crusher between instances, types and field names. To work correctly, be sure that this
	/// field is serialized, byt setting it to Public or using the [SerializeField] attribute.
	/// </summary>
	[System.Serializable]
	public class SharedFloatCrusher : SharedCrusherBase<FloatCrusher>
	{
		///// <summary>
		...
		///// </summary>
		//public SharedFloatCrusher() : base() { }
		...
		public SharedFloatCrusher(int hashcode) : base(hashcode) { }
		...
		/// </summary>
		/// <param name="hashcode"></param>
		public SharedFloatCrusher(string name) : base (name) { }
	...
	[CustomPropertyDrawer(typeof(SharedFloatCrusher))]
	[CanEditMultipleObjects]

	public class SharedFloatCrusherDrawer : SharedCrusherBaseDrawer<SharedFloatCrusher, FloatCrusher>
	{
